...
- `mlu` -> `impls/mlu__triton_fused_moe_005.py`
- `s60` -> `impls/s60__triton_fused_moe_002.py`
- `bi150` -> `impls/bi150__triton_fused_moe_002.py`
- `ascend` -> `impls/ascend__triton_fused_moe_003.py`
...
- 通用 fallback 文件：`impls/generic__triton_fused_moe_002.py`
