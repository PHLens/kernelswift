...
_BACKEND_TO_FILE = {'s60': 's60__triton_mm_encoder_attention_001.py', 'maca': 'maca__triton_mha_002.py', 'bi150': 'bi150__triton_mm_encoder_attention_001.py', 'ascend': 'ascend__triton_attn_001.py'}
_FALLBACK_FILE = 'generic__triton_mm_encoder_attention_001.py'
...
class ModelNew(nn.Module):
    def __init__(self, num_heads: int = 8, head_size: int = 64, num_kv_heads: int = 8):
        ...
        self.impl = self._impl_module.ModelNew(num_heads, head_size, num_kv_heads)
