...
- `mlu` -> `impls/triton_flexattention_003.py`
- `s60` -> `impls/triton_flexattention_001.py`
- `bi150` -> `impls/triton_flexattention_001.py`
- `ascend` -> `impls/triton_flexattention_002.py`
