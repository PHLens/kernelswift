...
- `mlu` -> `impls/mlu__triton_flexattention_003.py`
- `s60` -> `impls/s60__triton_flexattention_001.py`
- `bi150` -> `impls/bi150__triton_flexattention_001.py`
- `ascend` -> `impls/ascend__triton_flexattention_002.py`
...
- 通用 fallback 文件：`impls/generic__triton_flexattention_001.py`
