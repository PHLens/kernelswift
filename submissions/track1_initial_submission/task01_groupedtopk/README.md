...
- `mlu` -> `impls/mlu__triton_grouped_topk_004.py`
- `s60` -> `impls/s60__triton_grouped_topk_003.py`
- `maca` -> `impls/maca__triton_grouped_topk_001.py`
...
- 通用 fallback 文件：`impls/generic__triton_grouped_topk_002.py`
