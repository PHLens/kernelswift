...
_BACKEND_TO_FILE = {'s60': 's60__triton_mhc_post_layer_mix_001.py', 'maca': 'maca__triton_mhc_001.py', 'bi150': 'bi150__triton_mhc_post_layer_mix_001.py', 'ascend': 'ascend__candidate_001.py'}
_FALLBACK_FILE = 'generic__triton_mhc_post_layer_mix_001.py'
...
class ModelNew(nn.Module):
    def __init__(self):
        ...
        self.impl = self._impl_module.ModelNew()

    def forward(self, x: torch.Tensor, residual: torch.Tensor, post_layer_mix: torch.Tensor, comb_res_mix: torch.Tensor):
        return self.impl.forward(x, residual, post_layer_mix, comb_res_mix)
