# 赛题7：mhc_post_layer_mix

本目录是赛题 `mhc_post_layer_mix` 的正式提交材料。
...
- `s60` -> `impls/s60__triton_mhc_post_layer_mix_001.py`
- `maca` -> `impls/maca__triton_mhc_001.py`
- `bi150` -> `impls/bi150__triton_mhc_post_layer_mix_001.py`
...
- 通用 fallback 文件：`impls/generic__triton_mhc_post_layer_mix_001.py`
