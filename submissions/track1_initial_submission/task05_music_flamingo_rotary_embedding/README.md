...
- `s60` -> `impls/triton_rotary_002.py`
- `maca` -> `impls/triton_rotary_001.py`
- `bi150` -> `impls/triton_music_flamingo_rotary_embedding_001.py`
- `ascend` -> `impls/triton_rotary_001.py`
