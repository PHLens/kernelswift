# 赛题5：music_flamingo_rotary_embedding

本目录是赛题 `music_flamingo_rotary_embedding` 的正式提交材料。
...
- `s60` -> `impls/s60__triton_rotary_002.py`
- `maca` -> `impls/maca__triton_rotary_001.py`
- `bi150` -> `impls/bi150__triton_music_flamingo_rotary_embedding_001.py`
- `ascend` -> `impls/ascend__triton_rotary_001.py`
...
```bash
cd task05_music_flamingo_rotary_embedding
bash run.sh
```
