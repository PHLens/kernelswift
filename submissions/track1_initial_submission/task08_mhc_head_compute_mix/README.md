# 赛题8：mhc_head_compute_mix

本目录是赛题 `mhc_head_compute_mix` 的正式提交材料。
...
- 通用 fallback 文件：`impls/generic__triton_mhc_head_compute_mix_001.py`
...
```bash
cd task08_mhc_head_compute_mix
bash run.sh
```
