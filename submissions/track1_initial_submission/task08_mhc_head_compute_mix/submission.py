...
_BACKEND_TO_FILE = {'s60': 's60__triton_mhc_head_compute_mix_001.py', 'maca': 'maca__triton_mhcc_001.py', 'bi150': 'bi150__triton_mhc_head_compute_mix_001.py', 'ascend': 'ascend__candidate_001.py'}
_FALLBACK_FILE = 'generic__triton_mhc_head_compute_mix_001.py'
...
class ModelNew(nn.Module):
    def __init__(self, hc_mult: int = 4, sinkhorn_iters: int = 20, eps: float = 1e-6):
        ...
        self.impl = self._impl_module.ModelNew(hc_mult, sinkhorn_iters, eps)
