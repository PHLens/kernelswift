...
def _grouped_topk_fixed_kernel(
    ...
    expert_logit_0, expert_id_0 = tl.max(
        expert_remaining_0,
        axis=0,
        return_indices=True,
    ...
    expert_logit_1, expert_id_1 = tl.max(
        expert_remaining_1,
        axis=0,
        return_indices=True,
        return_indices_tie_break_left=True,
    ...
    expert_logit_2, expert_id_2 = tl.max(
        expert_remaining_2,
        axis=0,
        return_indices=True,
        return_indices_tie_break_left=True,
    ...
    expert_logit_3, expert_id_3 = tl.max(
        expert_remaining_3,
        axis=0,
        return_indices=True,
        return_indices_tie_break_left=True,
    ...
    expert_logit_4, expert_id_4 = tl.max(
        expert_remaining_4,
        axis=0,
        return_indices=True,
        return_indices_tie_break_left=True,
    ...
    expert_logit_5, expert_id_5 = tl.max(
        expert_remaining_5,
        axis=0,
        return_indices=True,
        return_indices_tie_break_left=True,
    ...
    expert_logit_6, expert_id_6 = tl.max(
        expert_remaining_6,
        axis=0,
        return_indices=True,
        return_indices_tie_break_left=True,
    ...
    expert_logit_7, expert_id_7 = tl.max(
        expert_remaining_7,
        axis=0,
        return_indices=True,
        return_indices_tie_break_left=True,
    ...
    def forward(self, hidden_states: torch.Tensor, gating_output: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        if fast_path:
            topk_weights = torch.empty(
                (83, 8), dtype=torch.float32, device=gating_output.device
            )
            topk_ids = torch.empty(
                (83, 8), dtype=torch.int32, device=gating_output.device
            )
