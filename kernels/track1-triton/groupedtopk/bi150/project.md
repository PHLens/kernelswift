...
| 009 | `rounds/decision_009.md` | `triton_grouped_topk_009.py` | accepted | `triton_grouped_topk_008.py` | 0.277234 | 14.898740234375 | 22.510768061134083 | confirmed | `triton_grouped_topk_009.py` |
