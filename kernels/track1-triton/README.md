...
|---|---|---|---|---|---|
| `groupedtopk` | ✅ 完结 · **6.56x**（v4，0.840→0.128 ms） | ✅ 完结 · **1.68x**（r003，0.459→0.274 ms）；r004 +2.06% 未达 5% 阈值 | 🔄 运行中 · 分支 `kernel-opt/grouptopk-c500-20260818` | 🔄 运行中 · 分支 `kernel-opt/bi150-prepare-20260818` | — |
...
|---|---|---|---|
| `groupedtopk` | [base.py](groupedtopk/base.py)（设备无关共享） | [mlu](groupedtopk/mlu/) · [s60](groupedtopk/s60/) | [mlu outcome](groupedtopk/mlu/outcome.md) · [s60 final summary](groupedtopk/s60/final_summary.md) |
