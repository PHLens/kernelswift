...
| `fused_moe` | ✅ **50.4x** · v5 · **6.940→0.138 ms** | ✅ **13.1x** · r002 · **5.112→0.390 ms**（逐-token 路由 + selection 融合） | — | — | ✅ **19.4x** · r002 · **7.159→0.369 ms** |
...
| `fused_moe` | [base.py](fused_moe/base.py)（设备无关共享） | [mlu](fused_moe/mlu/) · [s60](fused_moe/s60/) · [ascend](fused_moe/ascend/) | [mlu outcome](fused_moe/mlu/outcome.md)（bangc 探针见 track2） · [s60 project](fused_moe/s60/project.md) · [ascend r002 report](fused_moe/ascend/rounds/report_002.md) |
...
| `music_flamingo_rotary_embedding` | [base.py](music_flamingo_rotary_embedding/base.py) | [s60](music_flamingo_rotary_embedding/s60/) · [ascend](music_flamingo_rotary_embedding/ascend/) · [maca](music_flamingo_rotary_embedding/maca/) | [s60 project](music_flamingo_rotary_embedding/s60/project.md) · [ascend r001 report](music_flamingo_rotary_embedding/ascend/rounds/report_001.md) · [maca final summary](music_flamingo_rotary_embedding/maca/final_summary.md) |
