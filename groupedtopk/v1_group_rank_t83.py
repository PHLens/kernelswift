"""Specialize parallel group ranking to T=83 with a three-pointer launcher."""
...
class ModelNew(GroupedTopKModelNew):
    if "_group_rank_t83_fast" not in globals():
        globals()["_group_rank_t83_fast"] = fast_libentry()(
            _grouped_topk_group_rank_t83_kernel
        )
