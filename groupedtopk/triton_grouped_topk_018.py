"""Compact four selected 32-expert groups to 128 lanes before expert top-k."""
...
class ModelNew(GroupedTopKModelNew):
    if "_compact128_t83_fast" not in globals():
        globals()["_compact128_t83_fast"] = fast_libentry()(
            _grouped_topk_compact128_t83_kernel
        )
    run_out = staticmethod(grouped_topk_triton_compact128_out)
