"""Experiment with per-group argmax followed by a second-level winner reduction."""
...
class ModelNew(GroupedTopKModelNew):
    if "_hierarchical_t83_fast" not in globals():
        globals()["_hierarchical_t83_fast"] = fast_libentry()(
            _grouped_topk_hierarchical_t83_kernel
        )
    run_out = staticmethod(grouped_topk_triton_hierarchical_out)
